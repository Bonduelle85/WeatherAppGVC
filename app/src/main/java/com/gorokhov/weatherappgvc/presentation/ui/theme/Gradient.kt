...
object CardGradients {
    val gradients = listOf(
        ...
        Gradient(
            ...
            fourthColor = Color(0xFFFF6B47),
        ),
        // Океанская волна
        Gradient(
            firstColor = Color(0xFF37CFFF),
            secondColor = Color(0xFF37AFFF),
            thirdColor = Color(0xFF378FFF),
            fourthColor = Color(0xFF376FFF),
        ),
        // Весенняя зелень
        Gradient(
            firstColor = Color(0xFF8CFF37),
            secondColor = Color(0xFF6BFF47),
            thirdColor = Color(0xFF4AFF57),
            fourthColor = Color(0xFF37FF6B),
        ),
        // Лавандовый закат
        Gradient(
            firstColor = Color(0xFFDF37FF),
            secondColor = Color(0xFFBF47FF),
            thirdColor = Color(0xFF9F57FF),
            fourthColor = Color(0xFF7F67FF),
        ),
        // Коралловый риф
        Gradient(
            firstColor = Color(0xFFFF6B8B),
            secondColor = Color(0xFFFF8A6B),
            thirdColor = Color(0xFFFFA84A),
            fourthColor = Color(0xFFFFC629),
        ),
        // Глубокое море
        Gradient(
            firstColor = Color(0xFF00BCD4),
            secondColor = Color(0xFF0097A7),
            thirdColor = Color(0xFF00838F),
            fourthColor = Color(0xFF006064),
        ),
        // Осенний лес
        Gradient(
            firstColor = Color(0xFFFFA726),
            secondColor = Color(0xFFFF8A65),
            thirdColor = Color(0xFFA1887F),
            fourthColor = Color(0xFF8D6E63),
        ),
        // Ягодный микс
        Gradient(
            ...
            fourthColor = Color(0xFF3F51B5),
        ),
        // Тропический рай
        Gradient(
            firstColor = Color(0xFF00E676),
            secondColor = Color(0xFF00BCD4),
            thirdColor = Color(0xFF2196F3),
            fourthColor = Color(0xFF9C27B0),
        ),
        // Песчаные дюны
        Gradient(
            ...
            fourthColor = Color(0xFFA1887F),
        ),
        // Северное сияние
        Gradient(
            firstColor = Color(0xFF00BFA5),
            secondColor = Color(0xFF00ACC1),
            thirdColor = Color(0xFF5C6BC0),
            fourthColor = Color(0xFFAB47BC),
        ),
        // Кофейная палитра
        Gradient(
            firstColor = Color(0xFFD7CCC8),
