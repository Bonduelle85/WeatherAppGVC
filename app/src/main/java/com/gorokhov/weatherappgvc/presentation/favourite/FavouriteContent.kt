...
import com.gorokhov.weatherappgvc.presentation.ui.theme.Gradient
import com.gorokhov.weatherappgvc.presentation.ui.theme.Orange
    ...
    LazyVerticalGrid(
        ...
        itemsIndexed(
            ...
            CityCard(
                cityItem = cityItem,
                index = index,
                onClick = { component.onClickCityItem(cityItem.city) }
            )
        }
        item {
